...
export default function ConsultationCTA({ onOpenConsultation }: ConsultationCTAProps) {
  return (
    <section className="py-24 md:py-32 bg-[#0a0f18] text-white relative overflow-hidden border-t border-white/10">
      ...
      <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-[#0b5fff]/10 blur-[140px] rounded-full pointer-events-none" />
      ...
      >
        <span className="font-mono text-[10px] text-[#1FA67A] uppercase tracking-[0.2em] block font-bold mb-4">
        ...
        <p className="font-sans text-base md:text-lg text-white/60 max-w-2xl mx-auto mb-10 leading-relaxed font-light">
          Partner with Axon Engineering to deliver your most ambitious
          infrastructure and industrial projects with unprecedented precision.
        </p>

        <button
          onClick={onOpenConsultation}
          className="shimmer-sweep group inline-flex items-center gap-3 bg-[#0b5fff] text-white px-9 py-4 rounded-full font-sans text-xs md:text-sm font-bold uppercase tracking-widest hover:bg-[#0051e0] transition-all duration-300 shadow-[0_0_40px_rgba(11,95,255,0.3)] hover:shadow-[0_0_60px_rgba(11,95,255,0.55)] hover:-translate-y-0.5"
        >
