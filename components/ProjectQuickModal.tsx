          ...
          >
            ...
            <div className="p-4 sm:p-5 sm:px-7 border-b border-slate-100 bg-white relative shrink-0">
              ...
              <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 mb-1.5 pr-10">
                <span className="px-2.5 py-0.5 rounded-md bg-[#0b233a] text-white text-[10px] font-bold">
                  {project.endUser}
                </span>
                <span className="px-2.5 py-0.5 rounded-md bg-[#FF8A00] text-white text-[10px] font-bold">
                  {project.year}
                </span>
                {project.sector && (
                  <span className="px-2 py-0.5 rounded-md bg-slate-100 text-slate-700 border border-slate-200 text-[10px] uppercase font-semibold">
                    {project.sector}
                  </span>
                )}
              </div>
              ...
              {/* Title & Client */}
              <div className="pr-10">
                <div className="text-[10px] text-[#FF8A00] uppercase font-bold tracking-wider mb-0.5">
                  CLIENT: {project.client}
                </div>
                <h3 className="text-lg sm:text-2xl font-extrabold text-[#0b233a] leading-tight">
                  {project.title}
                </h3>
              </div>
            </div>
            ...
            <div className="p-4 sm:p-6 overflow-y-auto space-y-4 sm:space-y-5">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-lg grid grid-cols-2 sm:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-slate-200">
                <div className="p-3">
                  <div className="flex items-center gap-1.5 text-[9px] uppercase tracking-wider text-slate-500 mb-0.5 font-bold">
                    <Clock className="w-3 h-3 text-[#FF8A00]" />
                    <span>MAN-HOURS</span>
                  </div>
                  <span className="text-sm sm:text-base font-bold text-[#FF8A00]">
                ...
                <div className="p-3">
                  ...
                  <span className="text-sm sm:text-base font-bold text-[#0b233a]">
              ...
              {/* Scope Description */}
              <div>
                <h4 className="text-xs font-bold uppercase tracking-wider text-[#0b233a] mb-1.5 flex items-center gap-1.5">
              ...
              {project.highlights && project.highlights.length > 0 && (
                <div className="pt-2 border-t border-slate-100">
                  <h4 className="text-xs font-bold uppercase tracking-wider text-[#0b233a] mb-2 flex items-center gap-1.5">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#FF8A00]" />
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2">
                    {project.highlights.map((highlight, idx) => (
                      <div
                        key={idx}
                        className="flex items-start gap-2 py-1 border-b border-slate-100 text-slate-800"
                      >
              ...
              <div className="pt-3 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-2.5">
                <Link
                  ...
                  onClick={onClose}
                  className="w-full sm:w-auto px-4 py-2.5 rounded-lg border border-slate-300 hover:border-[#0b233a] text-[#0b233a] text-xs uppercase tracking-wider font-bold transition-all text-center flex items-center justify-center gap-1.5"
                >
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-5 py-2.5 rounded-lg bg-[#FF8A00] hover:bg-[#E67C00] text-white text-xs uppercase tracking-wider font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer"
                >
