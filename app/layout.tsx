...
export const metadata: Metadata = {
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL || "https://saurengineering.in"),
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${plusJakartaSans.variable} scroll-smooth h-full antialiased`}
    >
      <head>
      ...
      <body className="min-h-full flex flex-col bg-background text-on-background selection:bg-[#1FA67A] selection:text-white">
        {children}
      </body>
    </html>
  );
